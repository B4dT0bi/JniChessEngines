...
static option_t Option[] = {
   ...
   { "History Threshold",   true, "67",   "spin",  "min 0 max 100", NULL },

   { "Futility Pruning", true, "true", "check", "", NULL },
   { "Futility Margin",  true, "131",   "spin",  "min 0 max 500", NULL },
   { "Extended Futility Margin",  true, "180",   "spin",  "min 0 max 900", NULL },


   { "Delta Pruning", true, "true", "check", "", NULL },
   { "Delta Margin",  true, "74",    "spin",  "min 0 max 500", NULL },

   { "Quiescence Check Plies", true, "2", "spin", "min 0 max 2", NULL },

   { "Material",        true, "103", "spin", "min 0 max 400", NULL },
   { "Piece Activity",  true, "64", "spin", "min 0 max 400", NULL },
   { "Piece Square Activity",  true, "107", "spin", "min 0 max 400", NULL },
   { "King Safety",     true, "96", "spin", "min 0 max 400", NULL },
   { "Pawn Structure",  true, "75", "spin", "min 0 max 400", NULL },
   { "Passed Pawns",    true, "91", "spin", "min 0 max 400", NULL },

   { "Toga Lazy Eval", true, "true", "check", "", NULL },
   { "Toga Lazy Eval Margin",  true, "157",    "spin",  "min 0 max 900", NULL },
