...
static /* const */ int PieceSquareWeight = 274; // 100%
static /* const */ int PieceActivityWeight = 164; // 100%
static /* const */ int KingSafetyWeight = 246; // 100%
static /* const */ int PawnStructureWeight = 192; // 100%

static const int PawnFileOpening = 1;
static const int KnightCentreOpening = 8;
static const int KnightCentreEndgame = 8;
static const int KnightRankOpening = 2;
static const int KnightBackRankOpening = 2;
static const int KnightTrapped = 103;
static const int BishopCentreOpening = 3;
static const int BishopCentreEndgame = 7;
static const int BishopBackRankOpening = 4;
static const int BishopDiagonalOpening = 5;
static const int RookFileOpening = 3;
static const int QueenCentreOpening = 4; // was 0
static const int QueenCentreEndgame = 6;
static const int QueenBackRankOpening = 5;
static const int KingCentreEndgame = 14;
static const int KingFileOpening = 10;
static const int KingRankOpening = 14;
